...
<html lang="en" style="scroll-behavior: smooth;">
  <head>
    ...
    <!-- Icon -->
    <link rel="stylesheet" type="text/css" href="/resources/assets/css/LineIcons.2.0.css">
    <!-- Animate -->
    <link rel="stylesheet" type="text/css" href="/resources/assets/css/animate.css">
    <!-- Tiny Slider  -->
    <link rel="stylesheet" type="text/css" href="/resources/assets/css/tiny-slider.css">
    <!-- Tailwind css -->
    <link rel="stylesheet" type="text/css" href="/resources/assets/css/tailwind.css">
  </head>
  <body>
        ...
        <div class="flex justify-between">
          <div class="w-full text-center">
            ...
            <div class="text-center wow fadeInUp" data-wow-delay="1.6s">
              <img class="img-fluid mx-auto" src="/resources/assets/img/hero.svg" alt="">
            </div>
          </div>
        </div>
      </div>
...
<!--     <div id="preloader">
    ...
    <script src="/resources/assets/js/contact-form.js"></script>      
