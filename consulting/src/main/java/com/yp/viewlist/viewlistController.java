...
@Controller(value="viewlistController")
public class viewlistController extends BaseController {
	
	/**
	 * @Description  : MA 화면 이동
	 * @author       : JANGCHAEHOON
	 * @since        : 2022. 04. 24
	 * @return       : ModelAndView
	 */	
	@RequestMapping(value = "/MA{menuGbn}/{menuId}.go")
	public ModelAndView MA100(HttpServletRequest request, HttpServletResponse response, @PathVariable String menuGbn, @PathVariable String menuId) throws Exception{
		ModelAndView mv = new ModelAndView("/viewlist/MA" + menuGbn + "/" + menuId + "/" + menuId);
